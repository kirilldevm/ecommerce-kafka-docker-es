  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-muted-foreground">Register as a customer to place orders</p>
      </div>
        ...
        {({ errors, touched, handleChange, handleBlur, isSubmitting: formSubmitting }) => (
          <Form className="space-y-4">
            ...
            <FieldGroup>
              ...
              <Field
                data-invalid={Boolean(touched.confirmPassword && errors.confirmPassword)}
              >
            ...
            >
              {isSubmitting || formSubmitting ? 'Creating account…' : 'Create account'}
            </Button>
          </Form>
        )}
      </Formik>
