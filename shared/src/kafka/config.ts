...
/**
 * Reads Kafka connection settings from the environment.
 * - `KAFKA_BROKERS` — for Node on your machine (e.g. `localhost:9092`)
 * - `KAFKA_BROKERS_DOCKER` — for services running inside Compose (`kafka:29092`)
 */
